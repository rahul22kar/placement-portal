...
import {Layout, List, Typography, Tag, Divider, Spin, Icon, Descriptions, Avatar} from 'antd';
...
class Profile extends Component {
    ...
    render() {
        ...
        let profile = null;
        const {profileData, commonConstants, loading} = this.props;
                ...
                <div>
                    ...
                    >
                        <Content style={{textAlign: "center"}}>
                            <Avatar src={profileData.avatar_link} size={128} style={{margin: 10}} />
